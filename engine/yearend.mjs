 ...
 * 반영: 근로소득공제, 기본공제, 국민연금·건강·고용보험료 소득공제, 신용카드 소득공제(25% 초과분 15%/30%, 한도 총급여 7,000만원 이하 300만·초과 250만 — 2023년 사용분부터),
...
export function cardDeduction(g, credit, check) {
  ...
  const cap = g <= 70000000 ? 3000000 : 2500000;   /* 조특법 제126조의2 — 2023년 사용분부터 7,000만원 초과는 250만원 한 단계(1억 2천만원 초과 200만원 구간 폐지) */
