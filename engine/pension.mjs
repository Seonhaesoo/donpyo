 ...
 *   A값: 전체 가입자 최근 3년 평균 소득월액 (2026년 적용 3,193,511원)
 *   B값: 본인 가입기간 평균 소득월액 (기준소득월액 하한 41만·상한 659만원, 2026.7~2027.6)
 *   비례상수: 2025년 1.245(소득대체율 41.5%), 2026년부터 1.29(43%로 고정 — 2025년 3월 개정)
...
export const PENSION_ASOF = '2026년';
export const A_VALUE = 3193511;
export const B_MIN = 410000;
export const B_MAX = 6590000;
export const CONSTANT = { 2025: 1.245, 2026: 1.29 };
export const REPLACEMENT = { 2025: 0.415, 2026: 0.43 };
