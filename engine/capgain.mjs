 ...
 * 다주택 중과 한시 배제는 2026년 5월 9일에 끝났다(연장 없음, 정책브리핑 2026-04-24 — 5월 9일까지 토지거래허가를 신청한 거래 등은 4~6개월 경과 규정).
 * 기본 계산은 중과가 없는 경우(조정대상지역 밖 주택 등, 표1 공제 적용), 옵션(multi = 2 | 3)일 때 조정대상지역 중과.
...
export const SURCHARGE_UNTIL = '2026년 5월 9일';   /* 중과 유예가 끝난 날 — 문구는 "유예 종료"로 쓴다 */
